 ...
 *
 * - 该文件被包含于lpc8xx_pin.h \sa lpc84x_pin.h 其定义了GPIO平台引脚的各个功能。
 *
 * \internal
...
#ifndef __AM_LPC84X_GPIO_UTIL_H
#define __AM_LPC84X_GPIO_UTIL_H
...
/** 
 * \addtogroup am_lpc84x_if_gpio_util
 * \copydoc am_lpc84x_gpio_util.h
 * @{
 */
...
#define AM_LPC84X_GPIO_FIL_CYC_GET(data)  \
                              (AM_BITS_GET((data), \
                                           AM_LPC84X_GPIO_FIL_CYC_BITS_START, \
                                           AM_LPC84X_GPIO_FIL_CYC_BITS_LEN) \
                               -1)
...
#define AM_LPC84X_GPIO_FIL_DIV_GET(data) \
                              (AM_BITS_GET((data), \
                                           AM_LPC84X_GPIO_FIL_DIV_BITS_START, \
                                           AM_LPC84X_GPIO_FIL_DIV_BITS_LEN) \
                               - 1)
