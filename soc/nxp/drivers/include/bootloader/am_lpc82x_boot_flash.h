...
#ifndef __AM_LPC82X_BOOT_FLASH_H
#define __AM_LPC82X_BOOT_FLASH_H
#include "hw/amhw_lpc82x_iap.h"
#include "am_boot.h"
#include "am_boot_flash.h"

typedef struct am_lpc82x_boot_flash_devinfo {
    ...
    //uint32_t  flash_page_size;      /**< \brief 页大小 */
...
} am_lpc82x_boot_flash_devinfo_t;

typedef struct am_lpc82x_boot_flash_dev {
    ...
    am_lpc82x_boot_flash_devinfo_t *p_devinfo;      /**< \brief 设备信息结构体 */
}am_lpc82x_boot_flash_dev_t;
...
#endif /* __AM_LPC82X_BOOT_FLASH_H */
