...
#ifndef __AM_LPC84X_SPI_DMA_H
#define __AM_LPC84X_SPI_DMA_H
...
/**
 * \addtogroup am_lpc84x_if_spi_dma
 * \copydoc am_lpc84x_spi_dma.h
 * @{
 */
 ...
 * \brief SPI 设备信息结构体
 */
typedef struct am_lpc84x_spi_dma_devinfo {
...
} am_lpc84x_spi_dma_devinfo_t;

/**
 * \brief SPI 设备，必须16字节对齐
 */
typedef struct am_lpc84x_spi_dma_dev {
    am_spi_serv_t                      spi_serve;   /**< \brief SPI标准服务句柄 */
    const am_lpc84x_spi_dma_devinfo_t *p_devinfo;   /**< \brief SPI设备信息的指针 */
    ...
    am_lpc84x_dma_xfer_desc_t   g_desc[3];  /**< \brief DMA通道描述符 */

    am_lpc84x_dma_controller_t *p_ctr_tx;   /**< \brief DMA发送通道控制器 */
    am_lpc84x_dma_controller_t *p_ctr_rx;   /**< \brief DMA接收通道控制器 */

} am_lpc84x_spi_dma_dev_t;
