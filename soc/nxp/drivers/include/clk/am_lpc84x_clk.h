...
#ifndef __AM_LPC84X_CLK_H
#define __AM_LPC84X_CLK_H
...
/**
 * \addtogroup am_lpc84x_if_clk
 * \copydoc am_lpc84x_clk.h
 * @{
 */
...
typedef struct am_lpc84x_clk_devinfo {
    ...
    /**
     * \brief WDTOSC频率选择，参见 \ref grp_amhw_lpc84x_clk_wdtosc_rate
     */
    uint8_t wdtosc_freq;
