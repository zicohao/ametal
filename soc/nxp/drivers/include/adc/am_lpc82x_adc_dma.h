...
#ifndef  __am_lpc82x_adc_dma_H
#define  __am_lpc82x_adc_dma_H
 ...
 * \anchor grp_am_lpc82x_adc_dma_work_mode
 * @{
 */

/** \brief DMA传输模式 */
#define am_lpc82x_adc_dma_WORK_MODE_DMA          0

/** \brief 中断工作模式 */
#define am_lpc82x_adc_dma_WORK_MODE_INT         -1
 ...
 * \brief ADC 设备信息 
 */
typedef struct am_lpc82x_adc_dma_devinfo {
...
} am_lpc82x_adc_dma_devinfo_t;

/**
 * \brief ADC设备实例
 */
typedef struct am_lpc82x_adc_dma_dev {
 ...
 * 默认去初始化序列A 
 *
 * \param[in] handle : am_lpc82x_adc_dma_init() 初始化函数获得的ADC服务句柄
 *
 * \return 无 
 */
