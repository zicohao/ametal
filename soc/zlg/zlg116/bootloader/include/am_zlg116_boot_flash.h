...
#ifndef __AM_ZLG116_BOOT_FLASH_H
#define __AM_ZLG116_BOOT_FLASH_H
#include "am_zlg_flash.h"
#include "am_boot.h"
#include "am_boot_flash.h"

typedef struct am_zlg116_boot_flash_devinfo {
...
} am_zlg116_boot_flash_devinfo_t;

typedef struct am_zlg116_boot_flash_dev {
    ...
    am_zlg116_boot_flash_devinfo_t *p_devinfo;      /**< \brief 设备信息结构体 */
}am_zlg116_boot_flash_dev_t;
 ...
 */
am_boot_flash_handle_t am_zlg116_boot_flash_init(am_zlg116_boot_flash_dev_t     *p_dev,
                                                 am_zlg116_boot_flash_devinfo_t *p_devinfo);


#endif /* __AM_ZLG116_BOOT_FLASH_H */
