                            ...
                            void                *p_arg)
{
    ...
    case AM_ZLG217_PWR_MODE_RUN:    /* 运行模式 */

        __gp_pwr_dev->pwr_mode = AM_ZLG217_PWR_MODE_RUN;

        break;

    case AM_ZLG217_PWR_MODE_SLEEP:  /* 睡眠运行模式 */
    ...
    case AM_ZLG217_PWR_MODE_STOP:  /* 停止模式 */
    ...
    case AM_ZLG217_PWR_MODE_STANBY:  /* 待机模式 */
...
int am_zlg217_pwr_mode_into (am_zlg217_pwr_mode_t mode)
{
    ...
    case AM_ZLG217_PWR_MODE_SLEEP:  /* 睡眠模式 */
                           ...
                           void                  *p_arg)
{
    ...
    if (pwr_handle->p_pwrdevinfo->p_pvd_info->enable) {
        ...
        /* 清除中断线触发方式配置，PVD 对应于 AMHW_ZLG217_LINE_NUM16 */
        ...
        if (pwr_handle->p_pwrdevinfo->p_pvd_info->pvd_mode == 0) {
            ...
            /* 上升沿触发(表示电压从高下降到低于设定阀值时产生中断)，PVD 对应于 AMHW_ZLG217_LINE_NUM16 */
            amhw_zlg217_exti_rtsr_set(ZLG217_EXTI, AMHW_ZLG217_LINE_NUM16);
        } else if (pwr_handle->p_pwrdevinfo->p_pvd_info->pvd_mode == 1) {

            /* 下降沿触发(表示电压从低上升到高于设定阀值时产生中断)，PVD 对应于 AMHW_ZLG217_LINE_NUM16 */
            amhw_zlg217_exti_ftsr_set(ZLG217_EXTI, AMHW_ZLG217_LINE_NUM16);
        } else {

            /* 双边沿触发(表示电压上升或下降越过设定阀值时都产生中断)，PVD 对应于 AMHW_ZLG217_LINE_NUM16 */
            amhw_zlg217_exti_rtsr_set(ZLG217_EXTI, AMHW_ZLG217_LINE_NUM16);
            amhw_zlg217_exti_ftsr_set(ZLG217_EXTI, AMHW_ZLG217_LINE_NUM16);
        }

        /* 清 PVD 中断线标志位，PVD 对应于 AMHW_ZLG217_LINE_NUM16 */
        amhw_zlg217_exti_pending_clear(ZLG217_EXTI, AMHW_ZLG217_LINE_NUM16);

        /* 设置开放中断线请求 , PVD 对应于 AMHW_ZLG217_LINE_NUM16 */
        ...
        /* 设置禁止中断线请求 , PVD 对应于 AMHW_ZLG217_LINE_NUM16 */
        amhw_zlg217_exti_imr_clear(ZLG217_EXTI,  AMHW_ZLG217_LINE_NUM16);
