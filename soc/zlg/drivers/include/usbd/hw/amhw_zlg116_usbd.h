 ...
 * \endinternal
 */
#ifndef __AMHW_ZLG116_USBD_H
#define __AMHW_ZLG116_USBD_H
...
/**
 * \addtogroup amhw_zlg116_if_usbd
 * \copydoc ZLG116_USBd.h
 * @{
 */
...
#define  AMHW_ZLG116_USB_TOP_SPEED        0
#define  AMHW_ZLG116_USB_TOP_CONNECT      1
#define  AMHW_ZLG116_USB_TOP_RESET        3
#define  AMHW_ZLG116_USB_TOP_SUSPEND      4
#define  AMHW_ZLG116_USB_TOP_DP_DM_STATE  5
#define  AMHW_ZLG116_USB_TOP_ACTIVE       7

/**************************  USB_TOP Configuration  ***************************/
#define  AMHW_USB_SPEED            (1UL << AMHW_ZLG116_USB_TOP_SPEED)
#define  AMHW_USB_CONNECT          (1UL << AMHW_ZLG116_USB_TOP_CONNECT)
#define  AMHW_USB_RESET            (1UL << AMHW_ZLG116_USB_TOP_RESET)
#define  AMHW_USB_SUSPEND          (1UL << AMHW_ZLG116_USB_TOP_SUSPEND)
#define  AMHW_USB_DP_DM_STATE      (3UL << AMHW_ZLG116_USB_TOP_DP_DM_STATE)
 ...
 */
typedef enum {
    ZLG116_USB_SPEED_FULL,   /* 全速传输 */
    ZLG116_USB_SPEED_LOW     /* 低速传输 */
}zlg116_usb_speed_t;
...
{
    if (speed == ZLG116_USB_SPEED_FULL)
        p_usb->top &= (~AMHW_USB_SPEED);
    else if (speed == ZLG116_USB_SPEED_LOW)
        p_usb->top |= (AMHW_USB_SPEED);
}
...
{
    return ((p_usb->top & AMHW_USB_SPEED) >> AMHW_ZLG116_USB_TOP_SPEED);
}
 ...
 */
typedef enum {
    ZLG116_USB_DISCONNECT,   /* 断开连接 */
    ZLG116_USB_CONNECT       /* 连接 */
...
{
    if (connect == ZLG116_USB_DISCONNECT)
        p_usb->top &= (~AMHW_USB_CONNECT);
    else if (connect == ZLG116_USB_CONNECT)
        p_usb->top |= (AMHW_USB_CONNECT);
}
...
{
    return ((p_usb->top & AMHW_USB_CONNECT) >> AMHW_ZLG116_USB_TOP_CONNECT);
}
...
{
    if(reset == ZLG116_USB_NORESET)
        p_usb->top &= (~AMHW_USB_RESET);
    else if(reset == ZLG116_USB_RESET)
        p_usb->top |= (AMHW_USB_RESET);
}
...
{
    return ((p_usb->top & AMHW_USB_RESET) >> AMHW_ZLG116_USB_TOP_RESET);
}
 ...
 */
typedef enum {
    ZLG116_USB_SUSPEND_WORK,     /* 工作状态 */
    ZLG116_USB_SUSPEND_PENDING   /* 挂起状态 */
...
{
    return ((p_usb->top & AMHW_USB_SUSPEND) >> AMHW_ZLG116_USB_TOP_SUSPEND);
}
...
{
    return ((p_usb->top & AMHW_USB_DP_DM_STATE) >> AMHW_ZLG116_USB_TOP_DP_DM_STATE);
}
 ...
 */
typedef enum {
    ZLG116_USB_INACTIVE,     /* 总线不活跃 */
    ZLG116_USB_ACTIVE        /* 总线活跃 */
}zlg116_usb_active_t;
...
{
    if (active == ZLG116_USB_INACTIVE)
        p_usb->top &= (~AMHW_USB_ACTIVE);
    else if (active == ZLG116_USB_ACTIVE)
        p_usb->top |= (AMHW_USB_ACTIVE);
}
...
{
    return ((p_usb->top & AMHW_USB_ACTIVE) >> AMHW_ZLG116_USB_TOP_ACTIVE);
}

/***********************  USB_INT_STATE Configuration  ************************/
#define  AMHW_ZLG116_USB_INT_STATE_RSTF      (1UL << 0)   /* 总线复位请求 */
#define  AMHW_ZLG116_USB_INT_STATE_SUSPENDF  (1UL << 1)   /* 总线挂起 */
#define  AMHW_ZLG116_USB_INT_STATE_RESUMF    (1UL << 2)   /* 总线唤醒 */
#define  AMHW_ZLG116_USB_INT_STATE_SOFF      (1UL << 3)   /* 检测到SOF */
#define  AMHW_ZLG116_USB_INT_STATE_EPINTF    (1UL << 4)   /* 端点中断 */
...
{
    p_usb->int_state |= (state & AMHW_ZLG116_USB_INT_STATE_ALL);
}
...
#define  AMHW_ZLG116_EP_INT_STATE_EP0F        (1UL << 0)
#define  AMHW_ZLG116_EP_INT_STATE_EP1F        (1UL << 1)
#define  AMHW_ZLG116_EP_INT_STATE_EP2F        (1UL << 2)
#define  AMHW_ZLG116_EP_INT_STATE_EP3F        (1UL << 3)
#define  AMHW_ZLG116_EP_INT_STATE_EP4F        (1UL << 4)
...
#define  AMHW_ZLG116_EP0_INT_STATE_SETUP          (1UL << 0)  /* 接收到SETUP包 */
#define  AMHW_ZLG116_EP0_INT_STATE_END            (1UL << 1)  /* 端点传输完成 */
...
#define  AMHW_ZLG116_EP0_INT_STATE_OUT_NACK       (1UL << 5)
#define  AMHW_ZLG116_EP0_INT_STATE_OUT_ACK        (1UL << 6)
#define  AMHW_ZLG116_EP0_INT_STATE_OUT_STALL      (1UL << 7)
...
#define AMHW_ZLG116_USB_INT_EN_RSTIE       (1ul << 0)  /* USB 总线复位中断使能位 */
#define AMHW_ZLG116_USB_INT_EN_SUSPENDIE   (1ul << 1)  /* USB 总线挂起中断使能位 */
#define AMHW_ZLG116_USB_INT_EN_RESUMIE     (1ul << 2)  /* 唤醒中断使能位 */
#define AMHW_ZLG116_USB_INT_EN_SOFIE       (1ul << 3)  /* SOF 检测中断使能位 */
#define AMHW_ZLG116_USB_INT_EN_EPIE        (1ul << 4)  /* 端点中断使能位 */
...
#define  AMHW_ZLG116_EP_INT_EN_EP0IE          (1UL << 0)
#define  AMHW_ZLG116_EP_INT_EN_EP1IE          (1UL << 1)
#define  AMHW_ZLG116_EP_INT_EN_EP2IE          (1UL << 2)
#define  AMHW_ZLG116_EP_INT_EN_EP3IE          (1UL << 3)
#define  AMHW_ZLG116_EP_INT_EN_EP4IE          (1UL << 4)
...
#define  AMHW_ZLG116_EP0_INT_EN_SETUPIE        (1UL << 0) /* 接收到 SETUP 包 */
#define  AMHW_ZLG116_EP0_INT_EN_ENDIE          (1UL << 1) /* 传输完成 */
#define  AMHW_ZLG116_EP0_INT_EN_IN_NACKIE      (1UL << 2) /* IN 包应答 NACK */
#define  AMHW_ZLG116_EP0_INT_EN_IN_ACKIE       (1UL << 3) /* IN 包应答 ACK */
#define  AMHW_ZLG116_EP0_INT_EN_IN_STALLIE     (1UL << 4) /* IN 包应答 STALL */
#define  AMHW_ZLG116_EP0_INT_EN_OUT_NACKIE     (1UL << 5) /* OUT 包应答 NACK */
#define  AMHW_ZLG116_EP0_INT_EN_OUT_ACKIE      (1UL << 6) /* OUT 包应答 ACK */
#define  AMHW_ZLG116_EP0_INT_EN_OUT_STALLIE    (1UL << 7) /* OUT 包应答 STALL */
...
#define  AMHW_ZLG116_EPX_INT_STATE_ENDIE       (1UL << 1) /* 传输完成 */
#define  AMHW_ZLG116_EPX_INT_STATE_IN_NACKIE   (1UL << 2) /* IN 包应答 NACK */
#define  AMHW_ZLG116_EPX_INT_STATE_IN_ACKIE    (1UL << 3) /* IN 包应答 ACK */
#define  AMHW_ZLG116_EPX_INT_STATE_IN_STALLIE  (1UL << 4) /* IN 包应答 STALL */
#define  AMHW_ZLG116_EPX_INT_STATE_OUT_NACKIE  (1UL << 5) /* OUT 包应答 NACK */
#define  AMHW_ZLG116_EPX_INT_STATE_OUT_ACKIE   (1UL << 6) /* OUT 包应答 ACK */
#define  AMHW_ZLG116_EPX_INT_STATE_OUT_STALLIE (1UL << 7) /* OUT 包应答 STALL */
...
#define  AMHW_ZLG116_EPX_INT_EN_ENDIE       (1UL << 1) /* 传输完成 */
#define  AMHW_ZLG116_EPX_INT_EN_IN_NACKIE   (1UL << 2) /* IN 包应答 NACK */
#define  AMHW_ZLG116_EPX_INT_EN_IN_ACKIE    (1UL << 3) /* IN 包应答 ACK */
#define  AMHW_ZLG116_EPX_INT_EN_IN_STALLIE  (1UL << 4) /* IN 包应答 STALL */
#define  AMHW_ZLG116_EPX_INT_EN_OUT_NACKIE  (1UL << 5) /* OUT 包应答 NACK */
#define  AMHW_ZLG116_EPX_INT_EN_OUT_ACKIE   (1UL << 6) /* OUT 包应答 ACK */
#define  AMHW_ZLG116_EPX_INT_EN_OUT_STALLIE (1UL << 7) /* OUT 包应答 STALL */
...
{
    return p_usb->addr = (addr & AMHW_ZLG116_USBD_ADDR_MASK);
}
...
/******************************  EP_EN Configuration  *************************/
#define  AMHW_ZLG116_USB_EP0EN       (1UL << 0)
#define  AMHW_ZLG116_USB_EP1EN       (1UL << 1)
#define  AMHW_ZLG116_USB_EP2EN       (1UL << 2)
#define  AMHW_ZLG116_USB_EP3EN       (1UL << 3)
#define  AMHW_ZLG116_USB_EP4EN       (1UL << 4)
...
#define  AMHW_ZLG116_USB_DTOG3EN     (1UL << 5)
...
{
    return p_usb->tog_crl1_4 & AMHW_ZLG116_USB_DTOG_MASK;
}
...
typedef enum {
    ...
    ZLG116_USB_EPX3,
    ZLG116_USB_EPX4
}zlg116_usb_epx2_t;  /* 和ZLG116_USB_epx_t 区分 */
...
#define AMHW_ZLG116_USB_EPX_TRANEN    (1 << 7)    /* 使能传输 */
...
void amhw_zlg116_usbd_epx_transfer (amhw_zlg116_usbd_t *p_usb, zlg116_usb_epx2_t epx,
                                   uint8_t count)
{
    p_usb->epx_ctrl_arr[epx].epx_ctrl = AMHW_ZLG116_USB_EPX_TRANEN | count;
}
...
{
    if (p_usb->epx_ctrl_arr[epx].epx_ctrl & AMHW_ZLG116_USB_EPX_TRANEN)
        return 0;
    return 1;
}
...
#define  AMHW_ZLG116_USB_EP_HALT3     (1UL << 3)
#define  AMHW_ZLG116_USB_EP_HALT4     (1UL << 4)
...
#define  AMHW_ZLG116_USB_POWER_SUSPEN     (1UL << 0)
#define  AMHW_ZLG116_USB_POWER_SUSP       (1UL << 1)
#define  AMHW_ZLG116_USB_POWER_WKUP       (1UL << 3)

/**< \brief 挂起控制宏 */
/**< \brief 总线使能挂起宏 */
#define  AMHW_ZLG116_USB_SUSPDIS    0         /**< \brief 由控制器控制是否挂起 */
#define  AMHW_ZLG116_USB_SUSPEN    (1 << 0)   /**< \brief 根据挂起模式（位挂起宏）控制是否挂起 */

/**< \brief 位挂起宏 */
#define  AMHW_ZLG116_USB_SUSP       0         /**< \brief 挂起模式 */
#define  AMHW_ZLG116_USB_NORMAL    (1 << 1)   /**< \brief 正常工作模式 */
...
{
    p_usb->power |= (susp & (~AMHW_ZLG116_USB_POWER_WKUP));
}
...
{
    return (p_usb->power & ~AMHW_ZLG116_USB_POWER_WKUP);
}
...
{
    p_usb->power |= AMHW_ZLG116_USB_POWER_WKUP;
}
/**
 * @}if_ZLG116_USBd
 */
