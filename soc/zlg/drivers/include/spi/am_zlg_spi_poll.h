...
#ifndef __AM_ZLG_SPI_POLL_H
#define __AM_ZLG_SPI_POLL_H
...
/**
 * \addtogroup am_zlg_if_spi_poll
 * \copydoc am_zlg_spi_poll.h
 * @{
 */
 ...
 * \brief SPI设备信息结构体
 */
typedef struct am_zlg_spi_poll_devinfo {
...
} am_zlg_spi_poll_devinfo_t;

/**
 * \brief SPI设备
 */
typedef struct am_zlg_spi_poll_dev {

    am_spi_serv_t                   spi_serve;         /**< \brief SPI标准服务句柄 */
    const am_zlg_spi_poll_devinfo_t *p_devinfo; /**< \brief SPI设备信息的指针 */
