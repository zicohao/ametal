...
#ifndef __AM_ZMF159_CLK_H
#define __AM_ZMF159_CLK_H
...
/**
 * \addtogroup am_zmf159_if_clk
 * \copydoc am_zmf159_clk.h
 * @{
 */
 ...
 * \brief CLK 设备信息参数结构体
 */
typedef struct am_zmf159_clk_devinfo {
     ...
     */
    amhw_zmf159_pll_clk_src pllin_src;
    ...
    /**
     * \brief AHB1分频系数，AHBCLK = PLLOUT / DIV,AHB1最大频率为96Mhz
     *
     *    ahb_div |  DIV
     *   ---------------------
     *        0-7 |   1
...
} am_zmf159_clk_devinfo_t;

/**
 * \brief CLK 设备结构体
 */
typedef struct am_zmf159_clk_dev {
