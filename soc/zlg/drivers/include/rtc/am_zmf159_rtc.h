...
#ifndef __AM_ZMF159_RTC_H
#define __AM_ZMF159_RTC_H
...
#include "am_rtc.h"
#include "hw/amhw_zlg217_rtc.h"

/**
 * \addtogroup am_zmf159_if_rtc
 * \copydoc am_zmf159_rtc.h
 * @{
 */

#define  AM_ZMF159_RTC_CALLBACK_SECOND  (1 << 0)  /**< \brief RTC 秒中断回调函数编号 */
#define  AM_ZMF159_RTC_CALLBACK_ALARM   (1 << 1)  /**< \brief RTC 闹钟中断回调函数编号 */
#define  AM_ZMF159_RTC_CALLBACK_OVER    (1 << 2)  /**< \brief RTC 溢出中断回调函数编号 */

/**
 * \brief ZMF159 RTC 设备信息
 */
typedef struct am_zmf159_rtc_devinfo {
...
} am_zmf159_rtc_devinfo_t;

/**
 * \brief ZMF159 RTC 设备
 */
typedef struct am_zmf159_rtc_dev {
    ...
    const am_zmf159_rtc_devinfo_t *p_devinfo;       /**< \brief RTC 设备信息 */
}am_zmf159_rtc_dev_t;
 ...
 *
 * \param[in] handle       RTC 标准服务操作句柄
 * \param[in] type         中断类型，可选 AM_ZMF159_RTC_CALLBACK_SECOND
 *                                       AM_ZMF159_RTC_CALLBACK_ALARM
 *                                       AM_ZMF159_RTC_CALLBACK_OVER
 ...
 * \brief 解初始化 RTC
 *
 * \param[in] handle 使用 am_zmf159_rtc_init() 获取到的 RTC 标准服务操作句柄
 *
 * \return 无
 */
