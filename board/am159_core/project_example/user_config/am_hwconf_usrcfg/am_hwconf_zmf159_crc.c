...
/**
 * \file
 * \brief ZMF159 CRC 用户配置文件
 * \sa am_hwconf_zmf159_crc.c
 *
 * \internal
...
/**
 * \addtogroup am_if_src_hwconf_zmf159_crc
 * \copydoc am_hwconf_zmf159_crc.c
 * @{
 */

/** \brief CRC平台初始化 */
void __zmf159_crc_plfm_init (void)
{
...
/** \brief 解除CRC平台初始化 */
void __zmf159_crc_plfm_deinit (void)
{
...
static const am_zlg_crc_devinfo_t __g_crc_devinfo = {
     ZMF159_CRC_BASE,               /**< \brief CRC寄存器块基址 */
    __zmf159_crc_plfm_init,         /**< \brief 平台初始化 */
    __zmf159_crc_plfm_deinit        /**< \brief 平台去初始化 */
};
