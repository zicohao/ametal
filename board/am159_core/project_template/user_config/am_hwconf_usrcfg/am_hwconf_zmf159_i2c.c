...
static void __zlg_i2c1_bus_clean (void)
{
    ...
    am_gpio_pin_cfg(PIOB_6, PIOB_6_I2C1_SCL | PIOB_6_AF_OD);
    am_gpio_pin_cfg(PIOB_7, PIOB_7_I2C1_SDA | PIOB_7_AF_OD);
}
...
static void __zlg_i2c1_plfm_init (void)
{
     ...
     */
    am_gpio_pin_cfg(PIOB_6, PIOB_6_I2C1_SCL | PIOB_6_AF_OD | PIOB_6_SPEED_20MHz);
    am_gpio_pin_cfg(PIOB_7, PIOB_7_I2C1_SDA | PIOB_7_AF_OD | PIOB_7_SPEED_20MHz);
