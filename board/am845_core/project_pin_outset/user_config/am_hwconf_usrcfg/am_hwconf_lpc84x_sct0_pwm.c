...
am_local am_lpc_sct_pwm_ioinfo_t __g_sct0_pwm_ioinfo_list[] = {
    {__SCT0_OUT0_PIN, PIO_FUNC_SCT_OUT0, AM_LPC84X_GPIO_FUNC_GPIO | AM_GPIO_INPUT}, /* 通道 0 */
    {__SCT0_OUT1_PIN, PIO_FUNC_SCT_OUT1, AM_LPC84X_GPIO_FUNC_GPIO | AM_GPIO_INPUT}, /* 通道 1 */
    {__SCT0_OUT2_PIN, PIO_FUNC_SCT_OUT2, AM_LPC84X_GPIO_FUNC_GPIO | AM_GPIO_INPUT}, /* 通道 2 */
    {__SCT0_OUT3_PIN, PIO_FUNC_SCT_OUT3, AM_LPC84X_GPIO_FUNC_GPIO | AM_GPIO_INPUT}, /* 通道 3 */
    {__SCT0_OUT4_PIN, PIO_FUNC_SCT_OUT4, AM_LPC84X_GPIO_FUNC_GPIO | AM_GPIO_INPUT}, /* 通道 4 */
    {__SCT0_OUT5_PIN, PIO_FUNC_SCT_OUT5, AM_LPC84X_GPIO_FUNC_GPIO | AM_GPIO_INPUT}, /* 通道 5 */
};
