...
am_local void __lpc84x_usart4_plfm_init (void)
{
    ...
    am_gpio_pin_cfg(__U4_TXD_PIN, PIO_FUNC_U4_TXD);
    am_gpio_pin_cfg(__U4_RXD_PIN, PIO_FUNC_U4_RXD);
}
...
am_local void __lpc84x_usart4_plfm_deinit (void)
{
    ...
    am_gpio_pin_cfg(__U4_TXD_PIN, AM_LPC84X_GPIO_FUNC_GPIO);
    am_gpio_pin_cfg(__U4_RXD_PIN, AM_LPC84X_GPIO_FUNC_GPIO);
}
