...
//#define AM_FSL_ADC_DIF_EN           /**< \brief 使能差分功能 */
...
static void __fsl_plfm_adc0_init (void)
{
    ...
    am_gpio_pin_cfg(__ADC_DP0_GPIO, __GPIO_ADC0);

    /* 配置PIOE_21为ADC0_DM0输入 */
    am_gpio_pin_cfg(__ADC_DM0_GPIO, __GPIO_ADC0);
#else
    /* 配置PIOE_29为ADC0_SE0输入 */
    am_gpio_pin_cfg(__ADC_SE0_GPIO, __GPIO_ADC0);
