...
//    demo_zlg217_core_std_multichan_adc_entry();
//    demo_zlg217_core_hw_adc_dma_entry();
...
//    demo_zlg227_usbd_keyboard_entry();
//    demo_zlg227_usbd_printer_entry();
//    demo_zlg227_usbd_msc_entry();
//    demo_zlg227_usbd_vcom_entry();
    while (1) {
    }
}
