...
const am_fsl_tpm_timing_devinfo_t  __g_tpm1_timing_devinfo = {
    KL26_TPM1,                       /**< \brief 指向TPM寄存器块的指针 */
    INUM_TPM1,                       /**< \brief TPM1中断编号 */
    CLK_TPM1,                        /**< \brief 时钟号 */
	__kl26_plfm_tpm1_timing_init,    /**< \brief 平台初始化函数 */
	__kl26_plfm_tpm1_timing_deinit   /**< \brief 平台解析初始化函数 */
};

/** \brief TPM1 设备定义  */
am_fsl_tpm_timing_dev_t  __g_tpm1_timing_dev;

/** \brief tpm1 Timer 实例初始化，获得Timer标准服务句柄 */
