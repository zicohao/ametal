...
static void __zlg_i2c1_bus_clean (void)
{
    ...
    am_gpio_pin_cfg(__I2C_SCL, AM_GPIO_PUSH_PULL | AM_GPIO_OUTPUT_INIT_HIGH);
    am_gpio_pin_cfg(__I2C_SDA, AM_GPIO_PULLUP | AM_GPIO_INPUT);
    ...
    am_gpio_pin_cfg(__I2C_SCL, __GPIO_I2C_SCL);
