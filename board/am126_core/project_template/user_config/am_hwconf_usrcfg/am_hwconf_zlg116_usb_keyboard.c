...
/**
 * \file
 * \brief zlg126 USB_keyboard 用户配置文件
 * \sa am_zlg126_hwconfig_usb_keyboard.c
 *
 * \internal
...
/**
 * \addtogroup am_zlg116_if_hwconfig_src_usb_keyboard
 * \copydoc am_zlg116_hwconfig_usb_keyboard.c
 * @{
 */
...
static void __am_usbd_keyboard_deinit (void) {
    amhw_zlg116_usbd_connect_set((amhw_zlg116_usbd_t *)ZLG116_USB_BASE, ZLG116_USB_DISCONNECT);   /* 断开连接 */
...
/**< \brief 定义USB设备信息 */
static const am_zlg126_usbd_devinfo_t  __g_zlg126_usbd_keyboard_info = {
    ZLG116_USB_BASE,                  /**< \brief 寄存器基地址 */
    INUM_USB,                         /**< \brief 中断号 */
...
/** \brief AM126 USB设备实例 */
static am_zlg126_usbd_dev_t  __g_zlg_usbd_keyboard;


/** \brief usb_keyboard实例初始化，获得usb_keyboard标准服务句柄 */
am_usbd_keyboard_handle am_zlg126_usbd_keyboard_inst_init (void)
{
...
void am_zlg126_usbd_keyboard_inst_deinit (void)
{
