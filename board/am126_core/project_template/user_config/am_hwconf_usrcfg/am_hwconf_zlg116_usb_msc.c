...
/**
 * \file
 * \brief zlg116 USB_MSC 用户配置文件
 * \sa am_zlg116_hwconfig_usb_msc.c
 *
 * \internal
...
/**
 * \addtogroup am_zlg116_if_hwconfig_src_usb_msc
 * \copydoc am_zlg116_hwconfig_usb_msc.c
 * @{
 */
...
/**< \brief 定义USB设备信息 */
static const am_zlg126_usbd_devinfo_t  __g_zlg126_usbd_msc_info = {
    ZLG116_USB_BASE,                           /* 寄存器基地址 */
    INUM_USB,                                  /* 中断号 */
...
am_usbd_msc_handle am_zlg126_usb_msc_inst_init (void)
{
    return am_usbd_msc_init(&__g_usb_msc_dev,
                            ...
                            am_zlg126_usbd_init(&__g_zlg_usbd_msc, &__g_zlg126_usbd_msc_info));
}

/** \brief usb_msc解初始化，获得usb_msc标准服务句柄 */
void am_mzlg126_usb_msc_inst_deinit (void)
{
