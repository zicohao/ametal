...
/**< \brief 定义USB设备信息 */
static const am_zlg126_usbd_devinfo_t  __g_zlg126_usbd_printer_info = {
...
/** \brief 用于zlg126 的USB handle*/
static am_zlg126_usbd_dev_t  __g_zlg126_usb_printer_dev;

/** \brief usb_printer实例初始化，获得usb_printer标准服务句柄 */
am_usbd_printer_handle am_zlg126_usbd_printer_inst_init (void)
{
    return am_usbd_printer_init(&__g_usb_printer_dev,
                                &__g_usbd_printer_info,
                                 am_zlg126_usbd_init(&__g_zlg126_usb_printer_dev, &__g_zlg126_usbd_printer_info));
}

/** \brief usb_printer解初始化，获得usb_printer标准服务句柄 */
void am_zlg126_usbd_printer_inst_deinit (void)
{
