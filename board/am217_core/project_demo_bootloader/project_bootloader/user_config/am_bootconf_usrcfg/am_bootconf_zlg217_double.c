...
/**
 * \file
 * \brief ZLG217 bootloader 双区用户配置文件
 *
 * \internal
...
/**
 * \addtogroup am_if_src_bootconf_zlg217_double
 * \copydoc am_bootconf_zlg217_double.c
 * @{
 */
 ...
 */
static am_boot_flash_handle_t am_zlg217_boot_double_flash_inst_init(void)
{
...
am_boot_firmware_handle_t am_zlg217_boot_double_firmware_flash_inst_init()
{
    flash_handle = am_zlg217_boot_double_flash_inst_init();
 ...
 */
static am_arm_boot_devinfo_t __g_zlg217_boot_double_devinfo = {
    /**< \brief 应用代码区起始地址*/
    0x08004000,
    /** \brief ram起始地址 */
    0x20000000,
...
int am_zlg217_boot_double_inst_init()
{
    return am_arm_boot_init(&__g_zlg217_boot_double_devinfo);
}
