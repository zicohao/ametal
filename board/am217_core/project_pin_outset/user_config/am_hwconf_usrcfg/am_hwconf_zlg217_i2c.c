...
static void __zlg_i2c1_bus_clean (void)
{
    ...
    am_gpio_pin_cfg(__I2C1_SCL, AM_GPIO_PUSH_PULL | AM_GPIO_OUTPUT_INIT_HIGH);
    am_gpio_pin_cfg(__I2C1_SDA, AM_GPIO_PULLUP | AM_GPIO_INPUT);
...
static void __zlg_i2c1_plfm_deinit (void)
{
    ...
    am_gpio_pin_cfg(__I2C1_SCL, __PIO_GPIO);
    am_gpio_pin_cfg(__I2C1_SDA, __PIO_GPIO);
}
...
static void __zlg_i2c2_bus_clean (void)
{
    ...
    am_gpio_pin_cfg(__I2C2_SCL, AM_GPIO_PUSH_PULL | AM_GPIO_OUTPUT_INIT_HIGH);
    am_gpio_pin_cfg(__I2C2_SDA, AM_GPIO_PULLUP | AM_GPIO_INPUT);
    ...
    am_gpio_pin_cfg(__I2C2_SDA, __GPIO_I2C2_SDA);
}
