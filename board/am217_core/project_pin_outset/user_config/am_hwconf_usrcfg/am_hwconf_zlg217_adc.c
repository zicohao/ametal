...
{
    am_gpio_pin_cfg(__ADC1_IN0, __GPIO_ADC1_IN);     /* ADC1通道0 */
    am_gpio_pin_cfg(__ADC1_IN1, __GPIO_ADC1_IN);     /* ADC1通道1 */
    am_gpio_pin_cfg(__ADC1_IN2, __GPIO_ADC1_IN);     /* ADC1通道2 */
    am_gpio_pin_cfg(__ADC1_IN3, __GPIO_ADC1_IN);     /* ADC1通道3 */
    am_gpio_pin_cfg(__ADC1_IN4, __GPIO_ADC1_IN);     /* ADC1通道4 */
    am_gpio_pin_cfg(__ADC1_IN5, __GPIO_ADC1_IN);     /* ADC1通道5 */
    am_gpio_pin_cfg(__ADC1_IN6, __GPIO_ADC1_IN);     /* ADC1通道6 ，温度传感器通道*/
    am_gpio_pin_cfg(__ADC1_IN7, __GPIO_ADC1_IN);     /* ADC1通道7 ，电压传感器通道*/
