...
{
    am_gpio_pin_cfg(__I2C2_SCL_PIN, PIO_FUNC_I2C2_SCL | AM_GPIO_OPEN_DRAIN);
    am_gpio_pin_cfg(__I2C2_SDA_PIN, PIO_FUNC_I2C2_SDA | AM_GPIO_OPEN_DRAIN);
...
am_local am_const am_lpc_i2c_devinfo_t __g_lpc82x_i2c2_devinfo = {
    ...
    LPC82X_I2C2_BASE,           /* I2C2 寄存器块基址 */
    INUM_I2C2,                  /* I2C2 中断号 */
    CLK_I2C2,                   /* I2C2 时钟号 */
    10,                         /* 超时时间 */
    __lpc82x_i2c2_plfm_init,    /* 平台初始化函数 */
    __lpc82x_i2c2_plfm_deinit   /* 平台解初始化函数 */
};
