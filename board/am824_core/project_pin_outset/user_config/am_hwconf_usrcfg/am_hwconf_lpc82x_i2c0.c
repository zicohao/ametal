...
{
    am_gpio_pin_cfg(__I2C0_SCL_PIN, AM_LPC82X_GPIO_FUNC_OTHER1);
    am_gpio_pin_cfg(__I2C0_SDA_PIN, AM_LPC82X_GPIO_FUNC_OTHER1);
...
am_local am_const am_lpc_i2c_devinfo_t __g_lpc82x_i2c0_devinfo = {
    ...
    LPC82X_I2C0_BASE,           /* I2C0 寄存器块基址 */
    INUM_I2C0,                  /* I2C0 中断号 */
    CLK_I2C0,                   /* I2C0 时钟号 */
    10,                         /* 超时时间 */
    __lpc82x_i2c0_plfm_init,    /* 平台初始化函数 */
    __lpc82x_i2c0_plfm_deinit   /* 平台解初始化函数 */
};
