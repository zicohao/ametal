 ...
 * \endinternal
 */
#ifndef __LPC82X_PIN_OUTSET_H
#define __LPC82X_PIN_OUTSET_H
 ...
 * @{
 */  
#define __KEY_KP0_PIN          PIO0_1       /**< \brief 所有引脚可选 */
/** @} */   
 ...
 * @{
 */  
#define __LED0_PIN             PIO0_20      /**< \brief 所有引脚可选 */
#define __LED1_PIN             PIO0_21      /**< \brief 所有引脚可选 */  
/** @} */ 
...
#define __I2C1_SCL_PIN         PIO0_16      /**< \brief 所有引脚可选 */
#define __I2C1_SDA_PIN         PIO0_18      /**< \brief 所有引脚可选 */
    
#define __I2C2_SCL_PIN         PIO0_8       /**< \brief 所有引脚可选 */
#define __I2C2_SDA_PIN         PIO0_9       /**< \brief 所有引脚可选 */
 ...
 * @{
 */
#define __SPI0_SCK_PIN         PIO0_15      /**< \brief 所有引脚可选 */
#define __SPI0_MOSI_PIN        PIO0_12      /**< \brief 所有引脚可选 */
#define __SPI0_MISO_PIN        PIO0_13      /**< \brief 所有引脚可选 */
/** @} */                                                            
 ...
 * @{
 */
#define __U0_TXD_PIN           PIO0_4       /**< \brief 所有引脚可选 */
#define __U0_RXD_PIN           PIO0_0       /**< \brief 所有引脚可选 */
/** @} */                      
 ...
 * @{                          
 */                            
#define __U1_TXD_PIN           PIO0_8       /**< \brief 所有引脚可选 */
#define __U1_RXD_PIN           PIO0_9       /**< \brief 所有引脚可选 */
/** @} */                      
