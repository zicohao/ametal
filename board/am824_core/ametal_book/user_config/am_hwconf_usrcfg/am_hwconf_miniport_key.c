...
am_local am_const int __g_key_pins_row[] = {
    PIO0_6,    /* 第 0 行引脚 */
    PIO0_7     /* 第 1 行引脚 */
};

/** \brief MiniPort-KEY 按键列线引脚 */
am_local am_const int __g_key_pins_col[] = {
    PIO0_17,    /* 第 0 列引脚 */
    PIO0_23     /* 第 1 列引脚 */
};
...
am_local am_const
am_key_matrix_gpio_softimer_info_t __g_miniport_key_info = {
    {
        {
            2,                           /* 2 行按键 */
            2,                           /* 2 列按键 */
        ...
        __g_key_pins_row,                /* 按键行线引脚 */
        __g_key_pins_col,                /* 按键列线引脚 */
    },
    5,                                   /* 扫描时间间隔，5ms */
};

/** \brief MiniPort-KEY 设备实例 */
am_local am_key_matrix_gpio_softimer_t __g_miniport_key;
...
{
    return am_key_matrix_gpio_softimer_init(&__g_miniport_key,
                                            &__g_miniport_key_info);
}
