...
typedef struct m2m_result {
    am_lpc82x_dma_controller_t *p_ctr;  /**< \brief 通道控制器 */
                                ...
                                m2m_result_t *p_result)
{
    ...
    am_lpc82x_dma_transfer_build(
       &transfer,                           /* 传输结构 */
        ...
        dst,                                /* 目标地址 */
        nbytes,                             /* 传输大小 */
        AM_LPC82X_DMA_TRANS_WIDTH_8BIT  |   /* 传输宽度 */
        AM_LPC82X_DMA_TRANS_SRCINC_1X   |   /* 源地址增量 */
        AM_LPC82X_DMA_TRANS_DSTINC_1X);     /* 目标地址增量 */
