 ...
 *                      AM_LPC82X_DMA_STAT_INTA   A 中断发生
 *                      AM_LPC82X_DMA_STAT_INTB   B 中断发生
 *                      AM_LPC82X_DMA_STAT_INTERR 错误发生
 *
 * \return 无
 */
                                          ...
                                          int      len)
{
    ...
    /* DMA 传输配置 */
    flags1 = AM_LPC82X_DMA_XFER_VALID           | /* 当前通道描述符有效 */
             AM_LPC82X_DMA_XFER_RELOAD          | /* 传输完成重载通道描述符 */
             AM_LPC82X_DMA_XFER_SWTRIG          | /* 软件触发 */
             AM_LPC82X_DMA_XFER_WIDTH_8BIT      | /* 传输数据宽度：8 bit */
             AM_LPC82X_DMA_XFER_SRCINC_1X       | /* 源地址按 1 个数据宽度递增 */
             AM_LPC82X_DMA_XFER_DSTINC_1X       | /* 目标地址按 1 个数据宽度递增 */
             AM_LPC82X_DMA_XFER_SETINTA;          /* 使能中断 A */

    /* DMA 传输配置 */
    flags2 = AM_LPC82X_DMA_XFER_VALID           | /* 当前通道描述符有效 */
             AM_LPC82X_DMA_XFER_RELOAD          | /* 传输完成重载通道描述符 */
