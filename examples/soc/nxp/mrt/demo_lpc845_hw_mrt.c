 ...
 *
 * \par 源代码
 * \snippet demo_lpc845_hw_mrt.c src_lpc845_hw_mrt
 *
 * \internal
 * \par History
 *
...
/**
 * \addtogroup demo_if_lpc845_hw_mrt
 * \copydoc demo_lpc845_hw_mrt.c
 */
...
am_local void __mrt_irq_handler (void *p_arg)
{
    ...
    if (amhw_lpc_mrt_chan_pending_chk(p_hw_mrt, AMHW_LPC_MRT_CH(1))
        ...
        amhw_lpc_mrt_intval_set(p_hw_mrt,
                                AMHW_LPC_MRT_CH(1),
                                amhw_lpc84x_clk_system_clkrate_get() / 10,
                                AM_TRUE);
...
void demo_lpc845_hw_mrt_entry (amhw_lpc_mrt_t *p_hw_mrt, int inum)
{
    ...
    amhw_lpc_mrt_intval_set(p_hw_mrt,
                            AMHW_LPC_MRT_CH(0),
                            amhw_lpc84x_clk_system_clkrate_get() / 8000,
                            AM_TRUE);
    ...
    ticks = 100 * (amhw_lpc84x_clk_system_clkrate_get() / 1000000);
