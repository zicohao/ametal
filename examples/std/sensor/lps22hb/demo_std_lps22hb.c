...
/**
 * \file
 * \brief 压力温度传感器 LPS22HB 例程，通过标准接口实现
 *
 * - 实验现象：
 *   1. 每过一秒，通过串口打印压力和温度的值
 *
 * \par 源代码
 * \snippet demo_std_lps22hb.c src_std_lps22hb
 *
 * \internal
...
/**
 * \addtogroup demo_if_std_lps22hb
 * \copydoc demo_std_lps22hb.c
 */
...
{
    /* LPS22HB提供的所有通道ID列举 */
    const int       id[2] = {AM_LPS22HB_CHAN_1, AM_LPS22HB_CHAN_2};
