 ...
 *
 * \par 源代码
 * \snippet demo_zlg126_core_usbd_keyboard.c src_zlg126_core_usbd_keyboard
 *
 * \internal
...
/**
 * \addtogroup demo_if_demo_zlg126_core_usbd_keyboard
 * \copydoc demo_zlg126_core_usbd_keyboard.c
 */

/** [src_demo_zlg126_core_usbd_keyboard] */
...
void demo_zlg126_usbd_keyboard_entry (void)
{
    ...
    AM_DBG_INFO("demo zlg126_core usbd keyboard!\r\n");
    /* usb打印机实例初始化*/
    am_usbd_keyboard_handle handle = am_zlg126_usbd_keyboard_inst_init();
