 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_std_uart_ringbuf.c src_aml166_core_std_uart_ringbuf
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml166_core_std_uart_ringbuf
 * \copydoc demo_aml166_core_std_uart_ringbuf.c
 */

/** [src_aml166_core_std_uart_ringbuf] */
...
{
    AM_DBG_INFO("demo aml166_core std uart ringbuf!\r\n");
