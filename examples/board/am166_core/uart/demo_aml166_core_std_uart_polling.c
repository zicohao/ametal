 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_std_uart_polling.c src_aml166_core_std_uart_polling
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml166_core_std_uart_polling
 * \copydoc demo_aml166_core_std_uart_polling.c
 */

/** [src_aml166_core_std_uart_polling] */
...
{
    AM_DBG_INFO("demo aml166_core std uart polling!\r\n");
