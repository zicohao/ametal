 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_std_buzzer.c src_aml166_core_std_buzzer
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml166_core_std_buzzer
 * \copydoc demo_aml166_core_std_buzzer.c
 */

/** [src_aml166_core_std_buzzer] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo aml166_core std buzzer!\r\n");
