 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_std_softimer.c src_aml166_core_std_softimer
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml166_core_std_softimer
 * \copydoc demo_aml166_core_std_softimer.c
 */

/** [src_aml166_core_std_softimer] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo aml166_core std softimer!\r\n");
