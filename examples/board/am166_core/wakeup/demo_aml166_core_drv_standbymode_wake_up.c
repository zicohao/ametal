...
/**
 * \addtogroup demo_if_aml166_core_drv_standbymode_wake_up
 * \copydoc demo_aml166_core_drv_standbymode_wake_up.c
 */
 
/** [src_aml166_core_drv_standbymode_wake_up] */
...
{
    AM_DBG_INFO("demo aml166_core drv standbymode wake up!\r\n");
