 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_drv_sleepmode_wake_up.c src_aml166_core_drv_sleepmode_wake_up
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml166_core_drv_sleepmode_wake_up
 * \copydoc demo_aml166_core_drv_sleepmode_wake_up.c
 */

/** [src_aml166_core_drv_sleepmode_wake_up] */
...
{
    AM_DBG_INFO("demo aml166_core drv sleepmode wake up!\r\n");
