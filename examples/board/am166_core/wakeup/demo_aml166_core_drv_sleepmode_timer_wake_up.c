...
/**
 * \addtogroup demo_if_aml166_core_drv_sleepmode_timer_wake_up
 * \copydoc demo_aml166_core_drv_sleepmode_timer_wake_up.c
 */

/** [src_aml166_core_drv_sleepmode_timer_wake_up] */
