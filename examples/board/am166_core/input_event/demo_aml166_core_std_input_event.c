...
/**
 * \addtogroup demo_if_aml166_core_std_input_event
 * \copydoc demo_aml166_core_std_input_event.c
 */

/** [src_aml166_core_std_input_event] */
#include "ametal.h"
#include "am_vdebug.h"
...
{
    AM_DBG_INFO("demo aml166_core std input event!\r\n");
