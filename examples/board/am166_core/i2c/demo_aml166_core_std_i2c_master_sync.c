 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_std_i2c_master_sync.c src_aml166_core_std_i2c_master_sync
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml166_core_std_i2c_master_sync
 * \copydoc demo_aml166_core_std_i2c_master_sync.c
 */

/** [src_aml166_core_std_i2c_master_sync] */
...
{
    AM_DBG_INFO("demo aml166_core std i2c master sync!\r\n");
