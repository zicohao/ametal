...
/**
 * \addtogroup demo_if_aml166_core_std_i2c_slave
 * \copydoc demo_aml166_core_std_i2c_slave.c
 */

/** [src_aml166_core_std_i2c_slave] */
...
{
    AM_DBG_INFO("demo aml166_core std i2c slave!\r\n");
