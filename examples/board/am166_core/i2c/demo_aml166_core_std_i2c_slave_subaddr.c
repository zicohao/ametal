 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_std_i2c_slave_subaddr.c src_aml166_core_std_i2c_slave_subaddr
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml166_core_std_i2c_slave_subaddr
 * \copydoc demo_aml166_core_std_i2c_slave_subaddr.c
 */

/** [src_aml166_core_std_i2c_slave_subaddr] */
...
{
    AM_DBG_INFO("demo aml166_core std i2c slave subaddr!\r\n");
