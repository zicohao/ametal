 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_hw_i2c_master_poll.c src_aml166_core_hw_i2c_master_poll
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_aml166_core_hw_i2c_master_poll
 * \copydoc demo_aml166_core_hw_i2c_master_poll.c
 */

/** [src_aml166_core_hw_i2c_master_poll] */
#include "ametal.h"
#include "am_clk.h"
#include "am_gpio.h"
#include "am_vdebug.h"
...
{
    am_kprintf("demo aml166_core hw i2c master poll!\r\n");
