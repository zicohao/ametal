 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_std_spi_flash_int.c src_aml166_core_std_spi_flash_int
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_aml166_core_std_spi_flash_int
 * \copydoc demo_aml166_core_std_spi_flash_int.c
 */
 
/** [src_aml166_core_std_spi_flash_int] */
...
{
    AM_DBG_INFO("demo aml166_core std spi flash int!\r\n");
