 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_hw_spi_master.c src_aml166_core_hw_spi_master
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_if_aml166_core_hw_spi_master
 * \copydoc demo_aml166_core_hw_spi_master.c
 */

/** [src_aml166_core_hw_spi_master] */
...
{
    am_kprintf("demo aml166_core hw spi master!\r\n");
