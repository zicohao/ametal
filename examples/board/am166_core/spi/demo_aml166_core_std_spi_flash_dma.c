...
/**
 * \addtogroup demo_if_aml166_core_std_spi_flash_dma
 * \copydoc demo_aml166_core_std_spi_flash_dma.c
 */

/** [src_aml166_core_std_spi_flash_dma] */
...
{
    AM_DBG_INFO("demo aml166_core std spi flash dma!\r\n");
