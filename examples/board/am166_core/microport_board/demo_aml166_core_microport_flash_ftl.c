 ...
 *
 * - 操作步骤：
 *   1. 将 MicroPort FLASH 配板连接到 aml166-Core 的 MicroPort 接口。
 *
 * - 实验现象：
 *   1. 主机写数据到 FLASH；
 ...
 *
 * \par 源代码
 * \snippet demo_aml166_core_microport_flash_ftl.c src_aml166_core_microport_flash_ftl
 *
 * \internal
...
/**
 * \addtogroup demo_if_aml166_core_microport_flash_ftl
 * \copydoc demo_aml166_core_microport_flash_ftl.c
 */

/** [src_aml166_core_microport_flash_ftl] */
...
{
    AM_DBG_INFO("demo aml166_core microport flash ftl!\r\n");
