...
/**
 * \addtogroup demo_if_aml166_core_microport_eeprom_nvram
 * \copydoc demo_aml166_core_microport_eeprom_nvram.c
 */

/** [src_aml166_core_microport_eeprom_nvram] */
...
{
    AM_DBG_INFO("demo aml166_core microport eeprom nvram!\r\n");
