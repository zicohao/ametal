...
/**
 * \addtogroup demo_if_aml166_core_microport_ds1302
 * \copydoc demo_aml166_core_microport_ds1302.c
 */

/** [src_aml166_core_microport_ds1302] */
...
{
    AM_DBG_INFO("demo aml166_core microport ds1302!\r\n");
