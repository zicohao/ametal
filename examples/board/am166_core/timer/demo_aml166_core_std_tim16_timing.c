...
/**
 * \addtogroup demo_if_aml166_core_std_tim16_timing
 * \copydoc demo_aml166_core_std_tim16_timing.c
 */

/** [src_aml166_core_std_tim16_timing] */
...
{
    AM_DBG_INFO("demo aml166_core std tim16 timing!\r\n");
