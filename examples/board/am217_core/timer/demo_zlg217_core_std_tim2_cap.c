 ...
 *
 * \par 源代码
 * \snippet demo_zlg217_std_tim2_cap.c src_zlg217_std_tim2_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_zlg217_std_tim2_cap
 * \copydoc demo_zlg217_std_tim2_cap.c
 */

/** [src_zlg217_std_tim2_cap] */
#include "ametal.h"
#include "am_vdebug.h"
...
void demo_zlg217_core_std_tim2_cap_entry (void)
{
    ...
    AM_DBG_INFO("demo am217_core std tim2 cap!\r\n");

    /* TIM3 输出频率为 2KHz 的 PWM */
    am_pwm_config(pwm_handle, 0, 500000 / 2, 500000);
    am_pwm_enable(pwm_handle, 0);

    demo_std_timer_cap_entry(am_zlg217_tim2_cap_inst_init(), 1);
