...
/**
 * \addtogroup demo_amks16z_core_if_hw_i2s_polling
 * \copydoc demo_amks16z_core_hw_i2s_polling.c
 */

/** [src_amks16z_core_hw_i2s_polling] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_gpio.h"
#include "am_delay.h"
...
void demo_amks16z_core_hw_i2s_polling_entry (void)
{
    ...
    demo_fsl_hw_i2s_polling_entry(KL26_I2S0, &i2s0_clk);
}
/** [src_amks16z_core_hw_i2s_polling] */
