...
/**
 * \addtogroup demo_amks16z_core_if_hw_bme_deco_stores
 * \copydoc demo_amks16z_core_hw_bme_deco_stores.c
 */
 
/** [src_amks16z_core_hw_bme_deco_stores] */
#include "ametal.h"
#include "am_delay.h"
#include "am_led.h"
#include "am_gpio.h"
...
{
    AM_DBG_INFO("demo amks16z_core hw bme deco stores!\r\n");

    demo_kl26_hw_bme_deco_stores_entry();
}
