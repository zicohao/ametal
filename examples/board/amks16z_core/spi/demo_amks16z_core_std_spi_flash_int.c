 ...
 *
 * \par 源代码
 * \snippet demo_amks16z_core_std_spi_flash_int.c src_amks16z_core_std_spi_flash_int
 *
 * \internal
 * \par History
...
/**
 * \addtogroup demo_amks16z_core_if_std_spi_flash_int
 * \copydoc demo_amks16z_core_std_spi_flash_int.c
 */
 
/** [src_amks16z_core_std_spi_flash_int] */
...
void demo_amks16z_core_std_spi_flash_int_entry (void)
{
    ...
    cs_pin     = PIOD_0;
    spi_handle = am_kl26_spi0_int_inst_init();
