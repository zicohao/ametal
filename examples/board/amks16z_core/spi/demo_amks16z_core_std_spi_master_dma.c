 ...
 *
 * - 操作步骤:
 *   1. 将SPI MOSI和MISO短接(PIOD_2 == PIOD_3),虚拟从机设备连接
 *   2. 按下按键传输一次数据
 *
 * - 实验现象:
 * \note
...
/**
 * \addtogroup demo_amks16z_core_if_std_spi_master_dma
 * \copydoc demo_amks16z_core_std_spi_master_dma.c
 */

/** [src_amks16z_core_std_spi_master_dma] */
#include "ametal.h"
...
void demo_amks16z_core_std_spi_master_dma_entry (void)
{
    ...
    int             cs_pin;
    am_spi_handle_t spi_handle = am_kl26_spi0_dma_inst_init();
