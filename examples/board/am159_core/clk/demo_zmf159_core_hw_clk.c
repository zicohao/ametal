...
/**
 * \addtogroup demo_if_zmf159_hw_clk
 * \copydoc demo_zmf159_hw_clk.c
 */
...
void demo_zmf159_core_hw_clk_entry (void)
{
    ...
    AM_DBG_INFO("demo zmf159_core hw clk!\r\n");

    am_gpio_pin_cfg(PIOA_8, PIOA_8_MCO1 | PIOA_8_AF_PP | PIOA_8_SPEED_20MHz);

    amhw_zmf159_rcc_mco_src_set(7);
