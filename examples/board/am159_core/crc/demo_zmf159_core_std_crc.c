 ...
 *
 * \par 源代码
 * \snippet demo_zmf159_std_crc.c src_zmf159_std_crc
 *
 * \internal
...
/**
 * \addtogroup demo_if_zmf159_std_crc
 * \copydoc demo_zmf159_std_crc.c
 */
...
{
    AM_DBG_INFO("demo zmf159_core std crc!\r\n");

    am_crc_handle_t crc_handle;

    crc_handle = am_zmf159_crc_inst_init();
