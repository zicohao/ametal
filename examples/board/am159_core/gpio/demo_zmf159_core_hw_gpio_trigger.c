 ...
 *
 * \par 源代码
 * \snippet demo_am159_core_hw_gpio_trigger.c src_am159_core_hw_gpio_trigger
 *
 * \internal
...
/**
 * \addtogroup demo_if_am159_core_hw_gpio_trigger
 * \copydoc demo_am159_core_hw_gpio_trigger.c
 */

/** [src_am159_core_hw_gpio_trigger] */
#include "ametal.h"
#include "am_clk.h"
#include "am_vdebug.h"
#include "am_zmf159.h"
...
{
    AM_DBG_INFO("demo zmf159_core hw gpio trigger!\r\n");

    /* 使能时钟 */
    am_clk_enable(CLK_IOPA);
    am_clk_enable(CLK_SYSCFG);

    demo_zlg_hw_gpio_trigger_entry(ZMF159_GPIOA,
                                   ZMF159_SYSCFG,
                                   ZMF159_EXTI,
                                   PIOA_8,
