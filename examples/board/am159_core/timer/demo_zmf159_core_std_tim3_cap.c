 ...
 *
 * \par 源代码
 * \snippet demo_zmf159_core_std_tim3_cap.c src_zmf159_core_std_tim3_cap
 *
 * \internal
...
/**
 * \addtogroup demo_if_zmf159_core_std_tim3_cap
 * \copydoc demo_zmf159_core_std_tim3_cap.c
 */

/** [src_zmf159_core_std_tim3_cap] */
...
void demo_zmf159_core_std_tim3_cap_entry (void)
{
    ...
    AM_DBG_INFO("demo zmf159_core std tim3 cap!\r\n");

    /* TIM2 输出频率为 2KHz 的 PWM */
    am_pwm_config(pwm_handle, 0, 500000 / 2, 500000);
    am_pwm_enable(pwm_handle, 0);

    demo_std_timer_cap_entry(am_zmf159_tim3_cap_inst_init(), 0);
}
/** [src_zmf159_core_std_tim3_cap] */
