 ...
 *
 * \par 源代码
 * \snippet demo_zmf159_std_i2c_master_sync.c src_zmf159_std_i2c_master_sync
 *
 * \internal
...
/**
 * \addtogroup demo_if_zmf159_std_i2c_master_sync
 * \copydoc demo_zmf159_std_i2c_master_sync.c
 */

/** [src_zmf159_std_i2c_master_sync] */
#include "ametal.h"
#include "am_board.h"
#include "am_vdebug.h"
#include "am_i2c.h"
...
{
    AM_DBG_INFO("demo zmf159_core std i2c master sync!\r\n");

    demo_std_i2c_master_sync_entry(am_zmf159_i2c1_inst_init(),
                                   EEPROM_ADDR,
                                   TEST_LEN);
}
/** [src_zmf159_std_i2c_master_sync] */
