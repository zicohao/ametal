...
/**
 * \file
 * \brief am845 所有例程函数入口声明
 * \sa demo_am845_core_all_entries.h
 *
 * \internal
 ...
 */
void demo_am845_core_std_adc_int_entry (void);
 ...
 */
void demo_am845_core_std_buzzer_entry (void);
 ...
 */
void demo_am845_core_drv_dma_ping_pong_entry (void);
 ...
 */
void demo_am845_core_std_i2c_lm75_entry (void);
 ...
 */
void demo_am845_core_std_i2c_master_sync_entry (void);
 ...
 */
void demo_am845_core_hw_pll_entry (void);
 ...
 */
void demo_am845_core_hw_pmu_powerdown_entry (void);
 ...
 */
void demo_am845_core_std_sct_pwm_entry (void);
 ...
 */
void demo_am845_core_std_spi_flash_int_entry (void);
 ...
 */
void demo_am845_core_std_usart_rngbuf_entry (void);
 ...
 */
void demo_am845_core_std_wkt_timer_entry (void);
 ...
 */
void demo_am845_core_microport_ds1302_entry (void);

/**
 * \brief MicroPort-EEPROM 例程，通过 NVRAM 标准接口实现
 */
void demo_am845_core_microport_eeprom_nvram_entry (void);
 ...
 */
void demo_am845_core_microport_flash_ftl_entry (void);
 ...
 */
void demo_am845_core_microport_flash_entry (void);

/**
 * \brief MicroPort-RS485 例程，通过标准接口实现
 */
void demo_am845_core_microport_rs485_entry (void);

/**
 * \brief MicroPort-RTC(PCF85063) 例程，通过标准接口实现
 */
void demo_am845_core_microport_rtc_entry (void);
 ...
 */
void demo_am845_core_microport_usb_entry (void);
 ...
 */
void demo_am845_core_miniport_hc595_digitron_temp_entry (void);
 ...
 */
void demo_am845_core_miniport_hc595_led_entry (void);

/**
 * \brief MiniPort-KEY + MiniPort-View 例程，通过标准接口实现
 */
void demo_am845_core_miniport_key_digitron_entry (void);
 ...
 */
void demo_am845_core_miniport_zlg72128_entry (void);
 ...
 */
void demo_am845_core_zlg52810_auto_baudrate_entry(void);
