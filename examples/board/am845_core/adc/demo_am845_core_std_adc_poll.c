...
/**
 * \addtogroup demo_if_am845_core_std_adc_poll
 * \copydoc demo_am845_core_std_adc_poll.c
 */

/** [src_am845_core_std_adc_poll] */
#include "ametal.h"
#include "am_adc.h"
#include "am_vdebug.h"
#include "am_board.h"
...
void demo_am845_core_std_adc_poll_entry (void)
{
    ...
    AM_DBG_INFO("demo am845_core std adc poll!\r\n");

    demo_lpc_std_adc_poll_entry(am_lpc84x_adc0_int_inst_init(),
                                 __ADC_CHAN, 
                                100000);
