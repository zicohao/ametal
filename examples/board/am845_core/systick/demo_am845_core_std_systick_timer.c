 ...
 *
 * \note
 *    1. 由于 Systick 默认作为系统延时使用，使用测试本 Demo 前需要将
...
/**
 * \addtogroup demo_if_am845_core_std_systick_timer
 * \copydoc demo_am845_core_std_systick_timer.c
 */

/** [src_am845_core_std_systick_timer] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_board.h"
...
void demo_am845_core_std_systick_timer_entry (void)
{
    ...
    AM_DBG_INFO("demo am845 std systick timer\r\n");
