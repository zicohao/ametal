 ...
 *
 * \par 源代码
 * \snippet demo_am845_core_std_sct_pwm.c src_am845_core_std_sct_pwm
 *
 * \internal
...
/**
 * \addtogroup demo_if_am845_core_std_sct_pwm
 * \copydoc demo_am845_core_std_sct_pwm.c
 */

/** [src_am845_core_std_sct_pwm] */
#include "ametal.h"
#include "am_vdebug.h"
#include "am_board.h"
...
void demo_am845_core_std_sct_pwm_entry (void)
{
    ...
    demo_std_timer_pwm_entry(am_lpc84x_sct0_pwm_inst_init(), 0);
}
/** [src_am845_std_sct_pwm] */
