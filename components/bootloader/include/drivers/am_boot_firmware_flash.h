...
#ifndef __AM_BOOT_FIRMWARE_FLASH_H
#define __AM_BOOT_FIRMWARE_FLASH_H
...
typedef struct am_boot_firmware_flash_devinfo {
    ...
    uint32_t app_area_size;          /**< \brief 固件存放区的总大小 */
    uint32_t buf_size;               /**< \brief 固件存放缓冲区的大小 */
...
#endif /* __AM_BOOT_FIRMWARE_FLASH_H */
