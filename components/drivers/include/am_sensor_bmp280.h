...
/*
 * \brief 传感器BMP280提供的所有通道ID定义
 */
#define AM_BMP280_CHAN_1      0             /* BMP280 的通道1，压力传感器通道 */
#define AM_BMP280_CHAN_2      1             /* BMP280 的通道2，温度传感器通道 */

/**
 * \brief 传感器 BMP280 设备信息结构体
 */
...
typedef struct am_sensor_bmp280_dev {
    am_sensor_serv_t                  bmp280_dev; /*< \breif 传感器标准服务 */
    am_i2c_device_t                   i2c_dev;    /*< \brief i2c设备实例 */
    am_bmp280_calibration_data_t      cal_val;    /*< \brief 保存校准值 */
 ...
 *
 * \param[in] p_dev     : 指向传感器BMP280设备的指针
 * \param[in] p_devinfo : 指向传感器BMP280设备信息的指针
 ...
 *
 * \param[in] handle : am_sensor_bmp280_init()初始化函数获得的传感器标准服务句柄
 *
 * \return 无
 */
