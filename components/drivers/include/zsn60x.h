 ...
 * @{
 */
#define  ZSN60X_FRAME_HEAD_LENGHT               0x08 /* 帧头长度,帧信息之前的字节长度总共为8字节*/
#define  ZSN60X_FRAME_CHECK_LENGHT              0x02 /* 帧校验和长度,2字节 */
#define  ZSN60X_FRAME_FRAME_MIN_LENGHT          0x0A /* 最小帧长度10字节 */
#define  ZSN60X_BUFFER_SIZE_MAX                 282  /**< \brief 串口缓冲区最大情况为272 + 10 */
/**
 * \name 设备应用类定义
 *   设备命令帧类型标识
 * @{
 */
#define  ZSN60X_DEVICE_CONTROL_CMD              0x01 /**< \brief 设备控制类命令*/
#define  ZSN60X_MIFARE_CARD_CMD                 0x02 /**< \brief Mifare卡命令 */
#define  ZSN60X_ISO7816_PROTOCOL_CMD            0x05 /**< \brief ISO7816协议命令 */
#define  ZSN60X_ISO14443_PROTOCOL_CMD           0x06 /**< \brief ISO14443协议命令 */
#define  ZSN60X_CPU_CARD_CMD                    0x07 /**< \brief CPU卡命令 */
 ...
 * @{
 */
#define  ZSN60X_GET_DEVICE_INFO                 0x41 /**< \brief 获取设备信息*/
#define  ZSN60X_CONFIG_ICC_INTERFACE            0x42 /**< \brief 配置IC卡接口 */
#define  ZSN60X_CLOSE_ICC_INTERFACE             0x43 /**< \brief 关闭IC卡接口 */
#define  ZSN60X_SET_ICC_INTERFACE_PROTOCOL      0x44 /**< \brief IC接口协议 */
#define  ZSN60X_LOAD_ICC_KEY                    0x45 /**< \brief 装载IC密钥 */
#define  ZSN60X_SET_ICC_INTERFACE_REG           0x46 /**< \brief 设置IC接口寄存器 */
#define  ZSN60X_GET_ICC_INTERFACE_REG           0x47 /**< \brief 获取IC接口寄存器 */
#define  ZSN60X_SET_BAUD_RATE                   0x48 /**< \brief 设置波特率 */
#define  ZSN60X_SET_ICC_INTERFACE_OUTPUT        0x49 /**< \brief 设置天线驱动模式 */
#define  ZSN60X_SET_ANTENNA_CHANNAL             0x4B /**< \brief 设置天线通道 */
#define  ZSN60X_SET_LOCAL_ADDRESS               0x4C /**< \brief 设置从机地址 */
#define  ZSN60X_LED_CONTROL                     0x4D /**< \brief LED控制 */
#define  ZSN60X_BUZZER_CONTROL                  0x4E /**< \brief 蜂鸣器控制 */
#define  ZSN60X_READ_EEPROM                     0x62 /**< \brief 读EEPROM */
#define  ZSN60X_WRITE_EEPROM                    0x63 /**< \brief 写EEPROM */
#define  ZSN60X_AUTO_TEST                       0x48 /**< \brief 执行自动测试 */
#define  ZSN60X_READ_AUTO_TEST                  0x49 /**< \brief 读自动测试结果 */
/**
 * \name Mifare类卡命令定义
 *   用于ZSN60X  Mifare类的命令函数
 * @{
 */
#define  ZSN60X_MIFARE_REQUEST                  0x41 /**< \brief 卡请求*/
#define  ZSN60X_MIFARE_ANTICOLL                 0x42 /**< \brief 卡防碰撞 */
#define  ZSN60X_MIFARE_SELECT                   0x43 /**< \brief 卡选择 */
#define  ZSN60X_MIFARE_HALT                     0x44 /**< \brief 卡挂起 */
#define  ZSN60X_MIFARE_AUTH_E2                  0x45 /**< \brief 装载E2密钥 */
#define  ZSN60X_MIFARE_AUTH_KEY                 0x46 /**< \brief 直接密钥验证 */
#define  ZSN60X_MIFARE_READ                     0x47 /**< \brief Mifare卡读 */
#define  ZSN60X_MIFARE_WRITE                    0x48 /**< \brief Mifare卡写 */
#define  ZSN60X_MIFARE0_WRITE                   0x49 /**< \brief UltraLight卡写 */
#define  ZSN60X_MIFARE_VALUE                    0x4A /**< \brief Mifare卡值操作 */
#define  ZSN60X_MIFARE_RESET                    0x4C /**< \brief 卡复位 */
#define  ZSN60X_MIFARE_ACTIVE                   0x4D /**< \brief 卡激活 */
#define  ZSN60X_MIFARE_AUTO_DETECT              0x4E /**< \brief 自动检测 */
#define  ZSN60X_MIFARE_GET_AUTO_DETECT          0x4F /**< \brief 读自动检测数据 */
#define  ZSN60X_MIFARE_SET_VALUE                0x50 /**< \brief 设置值块的值 */
#define  ZSN60X_MIFARE_GET_VALUE                0x51 /**< \brief 获取值块的值 */
#define  ZSN60X_MIFARE_EXCHANGE_BLOCK1          0x58 /**< \brief 数据交互命令 */
#define  ZSN60X_MIFARE_MF0_CMD_TRANS            0x53 /**< \brief MF0卡片与PCD之间数据交互扩展命令 */

/**
 * \name ISO7816-3协议类命令定义
 *   用于 ZSN60X  ISO7816-3协议类的命令函数
 * @{
 */
#define  ZSN60X_CICC_TPDU                       0x42 /**< \brief 接触式IC卡传输协议（自动处理T=0和T=1协议 */
#define  ZSN60X_CICC_COLD_RESET                 0x43 /**< \brief 接触式IC卡冷复位 */
#define  ZSN60X_CICC_WARM_RESET                 0x44 /**< \brief 接触式IC卡热复位 */
#define  ZSN60X_CICC_DEACTIVATION               0x45 /**< \brief 接触式IC卡停活（关闭电源和时钟） */
#define  ZSN60X_CICC_TP0                        0x47 /**< \brief 接触式IC卡T=0传输协议 */
#define  ZSN60X_CICC_TP1                        0x48 /**< \brief 接触式IC卡T=1传输协议 */

/**
 * \name ISO1443(PICC)协议类命令定义
 *   用于 ZSN60X  ISO1443(PICC)协议类的命令函数
 * @{
 */
#define  ZSN60X_PICCA_REQUEST                   0x41 /**< \brief A型卡请求 */
#define  ZSN60X_PICCA_ANTICOLL                  0x42 /**< \brief A型卡防碰撞 */
#define  ZSN60X_PICCA_SELECT                    0x43 /**< \brief A型卡选择 */
#define  ZSN60X_PICCA_HALT                      0x44 /**< \brief A型卡挂起 */
#define  ZSN60X_PICCA_RATS                      0x45 /**< \brief A型卡RATS */
#define  ZSN60X_PICCA_PPS                       0x46 /**< \brief A型卡PPS */
#define  ZSN60X_PICCA_DESELECT                  0x47 /**< \brief DESELECT */
#define  ZSN60X_PICCA_TPCL                      0x48 /**< \brief T=CL */
#define  ZSN60X_PICCA_EXCHANGE_BLOCK2           0x4A /**< \brief 数据交换*/
#define  ZSN60X_PICCA_RESET                     0x4C /**< \brief A型卡复位（若支持ISO14443-4, 则自动执行RATS）*/
#define  ZSN60X_PICCA_ACTIVE                    0x4D /**< \brief A型卡激活*/
#define  ZSN60X_PICCB_ACTIVE                    0x4E /**< \brief B型卡激活*/
#define  ZSN60X_PICCB_RESET                     0x4F /**< \brief B型卡复位（执行ATTRIB）*/
#define  ZSN60X_PICCB_REQUEST                   0x50 /**< \brief B型卡请求*/
#define  ZSN60X_PICCB_ATTRIB                    0x52 /**< \brief B型卡修改传输属性（选择卡）*/
#define  ZSN60X_PICCB_HALT                      0x53 /**< \brief B型卡挂起*/
#define  ZSN60X_PICCB_GETUID                    0x54 /**< \brief 获取二代证UID*/


/**
 * \name PLUS CPU卡类命令定义
 *   用于 ZSN60X  PLUS CPU协议类的命令函数
 * @{
 */
#define  ZSN60X_SL0_WRITE_PERSO                  0x42 /**< \brief SL0个人化数据更新 */
#define  ZSN60X_SL0_COMMIT_PERSO                 0x43 /**< \brief SL0提交个人化 */
#define  ZSN60X_SL3_FIRST_AUTH                   0x4A /**< \brief SL3首次验证(直接密钥验证) */
#define  ZSN60X_SL3_FIRST_AUTH_E2                0x4B /**< \brief SL3首次验证(E2密钥验证) */
#define  ZSN60X_SL3_FOLLOWING_AUTH               0x4C /**< \brief SL3跟随验证(直接密钥验证) */
#define  ZSN60X_SL3_FOLLOWING_AUTH_E2            0x4D /**< \brief SL3跟随验证(E2密钥验证)*/
#define  ZSN60X_SL3_RESET_AUTH                   0x4E /**< \brief SL3复位验证 */
#define  ZSN60X_SL3_READ                         0x4F /**< \brief SL3读数据块 */
#define  ZSN60X_SL3_WRITE                        0x50 /**< \brief SL3写数据块*/
#define  ZSN60X_SL3_VALUE                        0x53 /**< \brief SL3值块操作*/

/**
 * \name 设备   标识宏定义
 * 用于ZSN60X设备的工作时的一些相关标识
 * @{
 */
#define   ZSN60X_EXECUTE_SUCCESS                 0x00 /**< \brief 设备操作成功  */
#define   ZSN60X_DEV_SERVER_ERR                  0xA1 /**< \brief 设备服务错误 设备为空  */
#define   ZSN60X_FRAME_LENGHT_RX_ERR             0xA2 /**< \brief 获取回应帧总长度错误  */
#define   ZSN60X_FRAME_INFO_RX_ERR               0xA3 /**< \brief 获取回应帧信息错误  */
#define   ZSN60X_FRAME_LENGHT_ERR                0xA4 /**< \brief 解析获取信息时,帧长度错误  */
#define   ZSN60X_FRAME_NO_SLV_ADDRS_ERR          0xA5 /**< \brief 解析获取信息时,无local address错误  */
#define   ZSN60X_FRAME_CHECK_SUM_ERR             0xA6 /**< \brief 解析获取信息时,校验和错误  */
#define   ZSN60X_IIC_TRANS_ERR                   0xA7 /**< \brief 发送时 IIC 通信返回错误  */
#define   ZSN60X_WORKMODE_INVALID                0xA8 /**< \brief 发送数据时  设备处于无效工作模式  */
#define   ZSN60X_UART_RX_TIMEOUT                 0xA9 /**< \brief 串口接收数据时超时  */
#define   ZSN60X_I2C_SEMB_TIMEOUT                0xAA /**< \brief I2C中断等待超时  */
#define   ZSN60X_INPUT_PARA_ERROR                0xAB /**< \brief 帧命令输入参数错误  */
/**
 * \name 设备工作工作模式
 * 用于ZSN60X设备的工作模式设置。
 * @{
 */
#define   ZSN60X_WORK_MODE_IIC                   0x00 /**< \brief IIC工作模式  */
#define   ZSN60X_WORK_MODE_UART                  0x01 /**< \brief UART工作模式  */

/**
 * \name 设备控制类指令  IC卡协议设置参数宏定义
 * 用于ZSN60X设备的设备控制类指令中的IC卡协议设置命令
 * @{
 */
#define   ZSN60X_ICC_ISO_TYPE_A                  0x00 /**< \brief iso14443-3A协议  */
#define   ZSN60X_ICC_ISO_TYPE_B                  0x04 /**< \brief iso14443-3B协议  */
 ...
 * @{
 */
#define   ZSN60X_ICC_KEY_TYPE_A                  0x60 /**< \brief 密钥 A  */
#define   ZSN60X_ICC_KEY_TYPE_B                  0x61 /**< \brief 密钥 B  */

/**
 * \name 设备控制类指令  波特率设置参数宏定义
 *   用于ZSN60X设备的波特率设置相关操作参数
 * @{
 */
#define  ZSN60X_BAUD_230400                      0x07 /**< \brief 230400 */
#define  ZSN60X_BAUD_172800                      0x06 /**< \brief 172800 */
#define  ZSN60X_BAUD_115200                      0x05 /**< \brief 115200 */
#define  ZSN60X_BAUD_57600                       0x04 /**< \brief 57600 */
#define  ZSN60X_BAUD_38400                       0x03 /**< \brief 38400 */
#define  ZSN60X_BAUD_28800                       0x02 /**< \brief 28800 */
#define  ZSN60X_BAUD_19200                       0x01 /**< \brief 19200 */
#define  ZSN60X_BAUD_9600                        0x00 /**< \brief 9600 */

/**
 * \name 设备控制类指令  天线模式设置参数宏定义
 *   用于ZSN60X设备的天线模式设置相关操作参数
 * @{
 */
#define  ZSN60X_ANT_MODE_TX12_LATERNATE          0x01 /**< \brief 天线TX1、TX2交替驱动 */
#define  ZSN60X_ANT_MODE_TX1                     0x01 /**< \brief 天线仅TX1驱动 */
#define  ZSN60X_ANT_MODE_TX2                     0x02 /**< \brief 天线仅TX2驱动 */
#define  ZSN60X_ANT_MODE_TX12                    0x03 /**< \brief 天线TX1、TX2同时驱动 */

/**
 * \name 设备控制类指令  控制LED设置参数宏定义
 *   用于ZSN60X设备的控制LED设置相关操作参数
 * @{
 */
#define  ZSN60X_CONTROL_LED_ON                   0x01 /**< \brief LED关闭 */
#define  ZSN60X_CONTROL_LED_OFF                  0x00 /**< \brief LED开启 */
 ...
 * @{
 */
#define  ZSN60X_MIFARE_REQUEST_IDLE              0x26 /**< \brief LED关闭 */
#define  ZSN60X_MIFARE_REQUEST_ALL               0x52 /**< \brief LED开启 */

/**
 * \name A卡 自动检卡模式  参数宏定义
 *   用于ZSN60X设备的A卡自动检卡模式命令参数
 * @{
 */
#define  ZSN60X_AUTO_DETECT_EXECUTE_HALT         0x08 /**< \brief 最后执行Halt() */
#define  ZSN60X_AUTO_DETECT_CONTINUE             0x04 /**< \brief 输出后继续执行 */
#define  ZSN60X_AUTO_DETECT_INTERRUPT            0x02 /**< \brief 产生中断 */
#define  ZSN60X_AUTO_DETECT_SEND                 0x01 /**< \brief 主动发送 */

#define  ZSN60X_AUTO_DETECT_NO_AUTH              0x00 /**< \brief 不进行验证 */
#define  ZSN60X_AUTO_DETECT_E2_AUTH              0x45 /**< \brief 使用E2密钥进行验证 */
#define  ZSN60X_AUTO_DETECT_KEY_AUTH             0x46 /**< \brief 使用用户输入密钥进行验证 */

/*****************************************************************
 *  ZSN60x  函数指针类型定义
 *****************************************************************/
/** \brief  ZSN60x命令传输函数指针类型定义*/
typedef uint8_t (*zsn60x_cmd_tx_func_t) (void          *p_drv,
                                         uint8_t       *p_cmd_data,
                                         uint32_t       cmd_lenght);
/** \brief  ZSN60x命令接收解析函数指针类型定义*/
typedef int (*zsn60x_cmd_rx_analysis_func_t) (void      *p_drv,
                                              uint32_t   buffer_len,
                                              uint8_t   *p_data,
                                              uint32_t  *p_data_lenght);
/** \brief  ZSN60x中断回调函数指针类型定义*/
typedef void (*zsn60x_int_cb) (void   *p_arg);

/** \brief  自动检测模式下检测到卡中断回调函数指针类型定义*/
typedef void (*zsn60x_card_input) (void   *p_arg);


/** \brief 回应帧信息结构体 */
typedef struct zsn60x_frame_info {
    uint32_t  status;                      /** \brief 执行状态 */
    uint32_t  info_lenght;                 /** \brief 信息长度 */
}zsn60x_frame_info_t;

/** \brief ZSN60x通用设备  无论使用何种通信方式  都会使用到该设备*/
typedef struct zsn60x_dev {
    ...
    zsn60x_card_input     pfn_card_cb;     /** \brief 自动检测 检测到卡后的用户回调*/
    void                 *p_arg;           /** \brief 自动检测 检测到卡后的用户回调参数*/

    zsn60x_cmd_tx_func_t  pfn_cmd_tx;      /** \brief 命令传输函数*/
    /** \brief 命令传输函数*/
    zsn60x_cmd_rx_analysis_func_t pfn_cmd_rx_analysis;
}zsn60x_dev_t;

/** \brief 定义ZSN60x操作句柄  所有的接口函数都会使用到该句柄 */
typedef zsn60x_dev_t *   zsn60x_handle_t;

/*****************************************************************
 *  ZSN60x  UART通信方式设备相关定义
 *****************************************************************/
/** \brief zsn60x 设备结构体(UART模式) */
typedef struct zsn60x_uart_devinfo {
    uint8_t  local_addr;                                  /** \brief 设备地址  */
    zsn60x_platform_uart_devinfo_t  platform_info;        /** \brief 平台相关设备信息  */
}zsn60x_uart_devinfo_t;


/** \brief zsn60x 设备结构体(UART模式) */
typedef struct zsn60x_uart_dev {
    zsn60x_dev_t               zsn60x_dev;                /** \brief ZSN60x 设备*/
    uint8_t                    is_wait ;                  /** \brief 目前等待数据的个数*/
    uint8_t                    rx_count;                  /** \brief 接收到的数据的个数*/
    /** \brief 串口接收数据缓冲区*/
    uint8_t                    buffer[ZSN60X_BUFFER_SIZE_MAX];
    ZSN60X_SEMB_DECL(uart_semb);                          /** \brief 串口信号量，用于获取串口数据的超时*/
    zsn60x_platform_uart_t     platform_dev;              /** \brief I2C模式平台设备*/
}zsn60x_uart_dev_t;

/*****************************************************************
 *  ZSN60x I2C通信方式设备相关定义
 *****************************************************************/
/** \brief zsn60x 设备信息结构体(I2C模式) */
typedef struct zsn60x_i2c_devinfo {
    uint8_t  local_addr;                          /** \brief 设备地址  */
    zsn60x_platform_i2c_devinfo_t platform_info;  /** \brief 平台相关设备信息  */
}zsn60x_i2c_devinfo_t;

/** \brief zsn60x设备结构体(I2C模式) */
typedef struct zsn60x_i2c_dev {
    zsn60x_dev_t              zsn60x_dev;         /** \brief ZSN60x 设备*/
    ZSN60X_SEMB_DECL(int_semb);                   /** \brief 中断信号量定义*/
    zsn60x_platform_i2c_t     platform_dev;       /** \brief I2C模式平台设备*/
}zsn60x_i2c_dev_t;

/**************************************************************
 * 自动检测模式结构体参数定义
 **************************************************************/
/** \brief zsn60x自动检测模式设置参数结构体定义 */
typedef struct zsn60x_auto_detect_ctrl {
    ...
    zsn60x_card_input   pfn_card_input;  /** \brief 检测到卡时的回调函数*/
    void               *p_arg;           /** \brief 检测到卡时的回调函数参数*/
}zsn60x_auto_detect_ctrl_t;

/** \brief zsn60x自动检测模式设置参数结构体定义 */
typedef struct zsn60x_auto_detect_data {
...
}zsn60x_auto_detect_data_t;
/**
 * \brief  ZSN60X 初始化(UART通信模式)
 *
 * \param[in] p_dev           : ZSN60X设备
 * \param[in] local_address   : ZSN60X设备local address
...
/**
 * \brief  ZSN60X 初始化(I2C通信模式)
 *
 * \param[in] p_dev           : ZSN60X设备
 * \param[in] p_devinfo       : ZSN60X设备设备信息
 *
 * \retval NULL   : 初始化错误
 * \retval handle : 执行成功
 */
...
/**
 * \brief  若ZSN60X 初始化使用IIC模式     必须将该终端函数作为中断引脚的回调函数
 *
 *         在IIC模式下，ZSN60X完成命令执行之后，中断引脚将会被拉低
 *         所以用户可以将 int_pin 配置为下降沿触发，并设置引脚中断回调函数为此函数，函数参数为 ZSN60X 设备句柄 即可
 *
 ...
 * \retval  0 : 执行成功
 */
void zsn60x_int_pin_hander(void *p_arg);
 ...
 *
 * \param[in] handle       : ZSN60X设备服务句柄
 * \param[in] isotype      : 协议类型   ZSN60X_ICC_ISO_TYPE_A
 *                                 ZSN60X_ICC_ISO_TYPE_B
 * \retval 其他 : 对应错误码
 * \retval  0 : 执行成功
 */
 ...
 *                ZSN60X_ANT_MODE_TX12_LATERNATE     ZSN60X_ANT_MODE_TX1
 *                ZSN60X_ANT_MODE_TX2                ZSN60X_ANT_MODE_TX12
 *
 * \retval 其他 : 对应错误码
 * \retval  0 : 执行成功
 */
 ...
 *
 * \retval 其他 : 对应错误码
 * \retval  0 : 执行成功  若执行成功后  ZSN60x设备地址会自动变为新的设置的值
 */
 ...
 *
 * \param[in] handle      : ZSN60X设备服务句柄
 * \param[in] control_led : 控制指令(1字节)  :ZSN60X_CONTROL_LED_ON
 *                                            ZSN60X_CONTROL_LED_OFF
 *
 * \retval 其他 : 对应错误码
 * \retval  0 : 执行成功
 */
 ...
 *                bit7 ~ bit4:保留
 *                bit3       :执行完之后的动作.
 *                            0-无动作;         1 - 最后执行HALT命令(ZSN60X_AUTO_DETECT_EXECUTE_HALT)
 *                bit2       :数据输出后.
 *                            0-不继续检测;      1 - 继续检测(ZSN60X_AUTO_DETECT_CONTINUE)
 *                bit1       :当UART接口检测到有卡时，是否产生中断,I2C模式设置无效，必定会产生中断
 *                            0-不产生中断;      1 - 产生中断(ZSN60X_AUTO_DETECT_INTERRUPT)
 *                bit0       :当UART接口时检测到有卡时，是否主动发送数据,I2C模式设置无效,从机不能主动发送数据
 *                            0不主动发送数据;    1 - 主动发送数据(ZSN60X_AUTO_DETECT_SEND)
 ...
 *                                              - 0x52~ALL
 * \param[in] authmode   : 验证模式AuthMode(1字节)  -'E'~用E2密钥验证 (ZSN60X_AUTO_DETECT_E2_AUTH)
 *                                              -'F'~用直接密钥验证(ZSN60X_AUTO_DETECT_KEY_AUTH)
 *                                              - 0 ~不验证  (ZSN60X_AUTO_DETECT_NO_AUTH)
 * \param[in] key_type   : 密钥AB KeyType(1字节):   0x60~密钥A  (ZSN60X_ICC_KEY_TYPE_A)
 *                                               0x61~密钥B (ZSN60X_ICC_KEY_TYPE_B)
...
/**
 * \brief  ZSN60x读自动测试结果指令
 *
 * \param[in] handle          : ZSN60X设备服务句柄
 * \param[in] p_success_times : 自动测试成功次数
 * \param[in] p_fail_times    : 自动测试失败次数
 * \param[in] p_all_times     : 自动测试总次数
 * \retval 其他 : 对应错误码
 * \retval  0 : 执行成功
 */
uint8_t zsn60x_read_auto_test(zsn60x_handle_t      handle,
                              uint8_t             *p_success_times,
                              uint8_t             *p_fail_times,
                              uint8_t             *p_all_times);
